...
public class Interaction : Photon.PunBehaviour
{
    ...
    {
        isMasterCapable(player1, player1.moveStamMult, new List<string> { "SleepLeft", "SwapTurnLeft" }, new List<string> { "MoveCloserLeft", "SwapTurnLeft" });
    }

    public void MoveFarerLeftBtn()
    {
        isMasterCapable(player1, player1.moveStamMult, new List<string> { "SleepLeft", "SwapTurnLeft" }, new List<string> { "MoveFarerLeft", "SwapTurnLeft" });
    }
    ...
    {
        isNonMasterCapable(player1, player1.moveStamMult, new List<string> { "SleepRight", "SwapTurnRight" }, new List<string> { "MoveCloserRight", "SwapTurnRight" });
    }

    public void MoveFarerRightBtn()
    {
        isNonMasterCapable(player1, player1.moveStamMult, new List<string> { "SleepRight", "SwapTurnRight" }, new List<string> { "MoveFarerRight", "SwapTurnRight" });
    }
